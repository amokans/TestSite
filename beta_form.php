...
<div class="container-fluid">
  <div class="row-fluid">
    ...
    <h1>Register</h1>
    <fieldset id="inputs">
    	<input id="firstName" type="text" placeholder="First Name" autofocus required>
        <input id="lastName" type="text" placeholder="Last Name" required>
        <input id="email1" type="email" placeholder="Email" required>
        <input id="email2" type="email" placeholder="Verify Email" required>
        <input id="employeeId" type="text" placeholder="Employee ID" required>   
